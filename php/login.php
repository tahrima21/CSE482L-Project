			...
			<div id='login-form'class='login-page'>
				...
				<!--Creation the Login Form-->
					<form action = "login-process.php" id='login' class='input-group-login' method = "post">
						<input type='text'name = "email" value="<?php if(isset($_COOKIE["email"])) { echo $_COOKIE["email"]; } ?>" class='input-field'placeholder='Email Id'>
						<input type='password' name = "psw" class='input-field'placeholder='Enter Password'required>
						<input type='checkbox' name = "check" class='check-box'><span style="color:aliceblue">Remember Me</span>
